...
function takeCallback(obj_spawned)
  ...
  if (myDes == "Main  Board") then
    ...
    if (myName == "Breach I") then
        obj_spawned.setPositionSmooth(mePos + vector(-10.5,3,7.1))
        obj_spawned.setRotation(obj_spawned.getTable('myRot'))
      end
    if (myName == "Breach II") then
        obj_spawned.setPositionSmooth(mePos + vector(-3.5,3,7.1))
        obj_spawned.setRotation(obj_spawned.getTable('myRot'))
    end
    ...
    if (myName == "Breach III") then
      ...
      if (myName == "Deck") then
        obj_spawned.setPositionSmooth(mePos + vector(-14,3,-6.4))
    ...
    if (myDes == "Bag 1") then
      ...
      obj_spawned.setPositionSmooth(mePos + vector(-2,16 + add,-3))
      obj_spawned.setRotation({0.00, 0.00, 0.00})
      obj_spawned.setDescription(obj_spawned.getGMNotes())
      obj_spawned.setGMNotes('')
    end
    if (myDes == "Bag 2") then
      obj_spawned.setPositionSmooth(mePos + vector(-2,12,-5))
      obj_spawned.setRotation({0.00, 0.00, 0.00})
      obj_spawned.setDescription(obj_spawned.getGMNotes())
      obj_spawned.setGMNotes('')
    end
    if (myDes == "Bag 3") then
      obj_spawned.setPositionSmooth(mePos + vector(-4,12,-3))
      obj_spawned.setRotation({0.00, 0.00, 0.00})
      obj_spawned.setDescription(obj_spawned.getGMNotes())
      obj_spawned.setGMNotes('')
    end
    if (myDes == "Bag 4") then
      obj_spawned.setPositionSmooth(mePos + vector(-4,12,-5))
      obj_spawned.setRotation({0.00, 0.00, 0.00})
      obj_spawned.setDescription(obj_spawned.getGMNotes())
      obj_spawned.setGMNotes('')
    end
    if (myDes == "Minor Deck Shuffled") then
      obj_spawned.setPositionSmooth(mePos + vector(-21,3,-6.4))
      obj_spawned.setRotation({0.00, 180.00, 180.00})
      obj_spawned.shuffle()
  end
...
if (myName == "Phoenix Breach") then
  obj_spawned.setPositionSmooth(mePos + vector(-3.48, 0.21, 7.22))
...
if (myName == "Phoenix Spell Deck") then
  obj_spawned.setPositionSmooth(mePos + vector(-9.68, 8, 10.17))
  obj_spawned.setRotation({0.00, 180.00, 180.00})
  obj_spawned.shuffle()
end
if (myDes == "Qu") or (myName == "[E7E52C]Tether Token[-]") then
  obj_spawned.setPositionSmooth(mePos + vector(-4.04,4,-5.6))
  if (myDes == "Qu") then
    obj_spawned.setRotation({0.00, 180.00, 180.00})
  else
    obj_spawned.setRotation({0.00, 180.00, 0})
...
if (myDes == "Taqren") or (myDes == "Zhana 1") then
  obj_spawned.setPositionSmooth(mePos + vector(-5.8,4,-1.8))
  obj_spawned.setRotation({0.00, 180.00, 0})
end
if (myDes == "Zhana 2") then
  obj_spawned.setPositionSmooth(mePos + vector(-1.8,4,-1.8))
  obj_spawned.setRotation({0.00, 180.00, 0})
end
if (myDes == "Zhana 3") then
  obj_spawned.setPositionSmooth(mePos + vector(-5.8,4,-6.2))
  obj_spawned.setRotation({0.00, 180.00, 0})
end
if (myDes == "Zhana 4") then
  obj_spawned.setPositionSmooth(mePos + vector(-1.8,4,-6.2))
  obj_spawned.setRotation({0.00, 180.00, 0})
end
if (myDes == "Zhana 5") then
  obj_spawned.setPositionSmooth(mePos + vector(-3.4,4,-9.8))
  obj_spawned.setRotation({0.00, 180.00, 0})
end
if (myDes == "Ohat") then
  obj_spawned.setPositionSmooth(mePos + vector(-4.04,4,-5.6))
...
if (myName == "Errated Deck") then
  ...
  obj_spawned.setPositionSmooth(binObj.getPosition() + vector(0,4,0))
end
...
if (myName == "Gygar Reminder Token") then
  if (obj_spawned.getDescription() ~= 'This effect is in addition to any Legacy sticker abilities.') then
    obj_spawned.setPositionSmooth(mePos + vector(-3.7, 4, -8.94))
    --im getting sick of eyeballing this so screw it
  else
  obj_spawned.setPositionSmooth(mePos + vector(-4.2, 8, -3.94))
  end
  obj_spawned.setRotation({0.00, 180.00, 0})
end
if (myName == "Builder Token") then
  obj_spawned.setPositionSmooth(mePos + vector(-5.49, 6, -4))
  obj_spawned.setRotation({0.00, 180.00, 0})
end
if (myName == "Rhys Breach Board") then
--{70.00, 1.85, -34.00}
    --{73.99, 2.00, -22.26}
      obj_spawned.setPositionSmooth(mePos + vector(3.99, 0.15, 10.74))
  obj_spawned.setRotation({0.00,180.00,0.00})
...
if (myName == "Destroyer Token") then
  obj_spawned.setPositionSmooth(mePos + vector(-2.39, 6, -4))
  obj_spawned.setRotation({0.00, 180.00, 0})
end
if (myDes == "Path1") then
  obj_spawned.setPositionSmooth(mePos + vector(-10.5, 4, -13.5))
  obj_spawned.setRotation({0.00, 180.00, 0})
end
if (myDes == "Path2") then
  obj_spawned.setPositionSmooth(mePos + vector(-5.5, 4, -13.5))
  obj_spawned.setRotation({0.00, 180.00, 0})
end
if (myDes == "Path3") then
  obj_spawned.setPositionSmooth(mePos + vector(10.5, 4, -13.5))
...
if (myDes == "Manifest Token") then
  obj_spawned.setPositionSmooth(mePos + vector(0, 0, -16.5))
  obj_spawned.setRotation({0.00, 180.00, 0})
end
if (myDes == "destiny token 1") then
  obj_spawned.setPositionSmooth(mePos + vector(-14, 0, -16.5))
  obj_spawned.setRotation({0.00, 180.00, 0})
end
if (myDes == "destiny token 2") then
  obj_spawned.setPositionSmooth(mePos + vector(-7, 0, -16.5))
  obj_spawned.setRotation({0.00, 180.00, 0})
end
